            ...
            Positioned.fill(
              child: AnimatedBuilder(
                ...
                builder: (BuildContext context, Widget? child) {
                  ...
                  final begin =
                      Alignment(-1.0 + 0.85 * flow, -1.0 + 0.20 * breathe);
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                          ...
                                          return TextField(
                                            ...
                                            decoration: decoration(
                                              ...
                                              prefixIcon: const Icon(
                                                  Icons.phone_iphone),
                                              suffixIcon: controller.phone.value
                                                      .trim()
                                                      .isEmpty
                                                  ? null
                                                  : IconButton(
                                        ...
                                        Obx(() {
                                          final msg = controller.errorText.value
                                              .trim();
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Path makeWave(double y, double amp, double freq) {
      ...
      for (int i = 0; i <= samples; i++) {
        final x = w * (i / samples);
        final wave = math.sin(
          (i / samples) * math.pi * 2 * freq + phase * math.pi * 2,
        );
        final yy = y + wave * amp;
        if (i == 0) {
          path.moveTo(x, yy);
